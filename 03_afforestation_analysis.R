...
colnames(master)[colnames(master) == "X.13..Afforestation..active.planting.in.non.forest.ecosystem.e.g..natural.grasslands."] <- "afforestation"
colnames(master)[colnames(master) == "Total.Area"] <- "area"  
colnames(master)[colnames(master) == "Restoration.Start.Year"] <- "begin.year"  

master %>%
  filter(afforestation == 1) -> master
